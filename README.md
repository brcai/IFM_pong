...
run model_testing.py to test the trained state neural network

% to do: the computation of individual neurons can be implemented by matrix multiplication to improve efficiency.
